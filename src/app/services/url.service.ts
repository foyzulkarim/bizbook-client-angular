export class UrlService {
  ...
  constructor() {
    ...
    this.setDefaultPasswordUrl =
      this.identityBaseApi + '/Account/SetDefaultPassword';
    ...
    this.applicationUserRoleQuery =
      this.identityBaseApi + '/ApplicationUserRoleQuery';
    ...
    this.applicationResourceQuery =
      this.identityBaseApi + '/ApplicationResourceQuery';
    ...
    this.applicationPermissions =
      this.identityBaseApi + '/ApplicationPermissions';
    this.applicationPermissionQuery =
      this.identityBaseApi + '/ApplicationPermissionQuery';
    this.applicationPermissionQueryData =
      this.applicationPermissionQuery + '/Data';
    ...
    this.customerFeedbackQuery =
      this.inventoryBaseApi + '/CustomerFeedbackQuery';
    ...
    this.operationLogDetailQuery =
      this.inventoryBaseApi + '/OperationLogDetailQuery';
    ...
    this.installmentDetailQuery =
      this.inventoryBaseApi + '/InstallmentDetailQuery';
  }
